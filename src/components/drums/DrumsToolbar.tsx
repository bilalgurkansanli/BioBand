...
type DrumsToolbarProps = {
  isRecording: boolean;
  metronomeOn: boolean;
  fxOn?: boolean;
  volume?: number;
  /** Accent of the active kit — colors the kit picker icon. */
  kitAccent?: string;
  onBack: () => void;
  onRecordPress: () => void;
  ...
  return (
    <View style={styles.bar}>
      ...
      <IconButton
        active={metronomeOn}
        icon="pulse-outline"
        label={t('drums.toolbar.metronome')}
      ...
      <IconButton
        ...
        label={t('drums.toolbar.volume')}
        onPress={onVolumePress}
      />
      <IconButton
        colorOverride={kitAccent}
        icon="musical-notes-outline"
        label={t('drums.toolbar.kit')}
        onPress={onKitPress}
      />
      <IconButton
        accent="game"
        icon="game-controller-outline"
        label={t('drums.toolbar.game')}
        onPress={onGamePress}
      />
      <IconButton
        icon="settings-outline"
        label={t('drums.toolbar.settings')}
